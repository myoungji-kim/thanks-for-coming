...
<body>
	<?   
        ...
        $sql="SELECT COUNT(*) FROM Member WHERE Member_Role=\"관리자\";";
	    ...
	    $sql="SELECT * FROM Member WHERE Member_Role=\"관리자\" ORDER BY Member_No DESC LIMIT ".($_GET["pg"]-1)*$SET_LIST_SIZE.",".$SET_LIST_SIZE." ";
    ...
    <div class = "AdminBottom">
	    ...
	    <form action = "MembersSave.php" method="post" enctype="multipart/form-data" name="MembersSave">
			<div class = "AdminTable">
				<span class = "Title"> 전체 관리자 (<?=$CountPost?>) </span>
				<table class = "Table">
					<thead class = "Top">
						<tr>
					...
					<tr id = "Rows">
							...
							<td class = "JoinDate"> <span class = "Text"> <? echo date("Y-m-d",strtotime ($row['Member_Date'])); ?> </span> </td>
				...
				<div class="PagingContainer">
					<?
						...
						$pagego= new paging;
						$pagego->pagelink($SET_LIST_SIZE, 10, $_GET["pg"], $CountPost ,"AdminMembersManager.php", "pg", $PRM_2);
					?>
				</div>
			</div>
